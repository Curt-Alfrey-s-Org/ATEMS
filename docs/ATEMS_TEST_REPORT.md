...
- **Splash login:** Root `/` shows login-first splash; user/admin credentials required
...
- **Credentials:** user/user123 · admin/admin123
- **Template:** `templates/splash_login.html` (full-screen, tool crib background)
- **Logout** → Redirects to `/` (splash login)
- **Demo users:** Run `python scripts/seed_demo_users.py` to create user, admin
